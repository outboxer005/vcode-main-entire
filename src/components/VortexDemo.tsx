...
export function VortexDemo() {
  return (
    <div className="w-full h-full mx-auto flex flex-col justify-center items-center px-4 sm:px-8 md:px-16 lg:px-24 pb-20 md:pb-32 overflow-hidden">
      <motion.p
      ...
      >
        <p className="text-base sm:text-xl md:text-2xl font-bold text-white/95 text-center px-4 md:px-16 lg:px-32 leading-relaxed max-w-6xl mx-auto">
          Experience the thrill of coding, creativity, and competition. Join the
          fest, showcase your talent, participate in exciting events, and earn
          certificates.
        </p>
      </motion.div>
    </div>
