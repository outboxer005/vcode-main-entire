  ...
  return (
    <section className="min-h-screen bg-[var(--background)] py-16 md:py-20">
      <div className="text-center mb-12 md:mb-16 px-4">
        ...
        >
          A brilliant amalgamation of Technical, Cultural, E-Sports, Sports, and Literature events. Compete, collaborate, and showcase your talents. Join the ultimate celebration of the year!
        </motion.p>
      </div>
